 ...
 * @Last Modified time: 2019-05-15 15:08:19
 */

import * as React from 'react';
import './index.less';
import { ActionSheet, Button, Toast } from 'antd-mobile';
import { getUrlParams, bMapTransQQMap, detectOS } from 'src/common';
import { Map, Marker, NavigationControl, Label } from 'react-bmap';
import { BmapApi } from 'src/common/bmap';
import POS_ICON from 'src/assets/images/mao-pos-icon.png';
...
export class CurrentLocation extends React.Component<PropsType, any> {
  ...
  callApp = (button: string) => {
    console.log(button);
    const { longitude, latitude, desLatitude, desLongitude, address, placename } = this.state;
    switch (button) {
      case '百度地图':
